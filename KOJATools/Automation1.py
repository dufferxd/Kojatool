...
class PostToFeed():
    ...
    def Execute(self):
        if not self.r or not self.cookie: tur = {'status':'failed','id':None,'message':'cookie invalid'}
            ...
            except Exception as e: tur = {'status':'failed','id':None,'message':'There is an error'}
        return(tur)
...
class ReactToPost():
    ...
    def Execute(self):
        if not self.r or not self.cookie: tur = {'status':'failed','react_type':None,'message':'cookie invalid'}
            ...
            except Exception as e: tur = {'status':'failed','react_type':react_type,'message':'There is an error'}
        return(tur)
